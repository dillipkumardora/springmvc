		...
		<div class="container">
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="resources/images/3.jpg" />
									<img class="etalage_source_image" src="resources/images/3.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="resources/images/4.jpg" />
								<img class="etalage_source_image" src="resources/images/4.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="resources/images/5.jpg" />
								<img class="etalage_source_image" src="resources/images/5.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="resources/images/6.jpg" />
								<img class="etalage_source_image" src="resources/images/6.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="resources/images/7.jpg" />
								<img class="etalage_source_image" src="resources/images/7.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="resources/images/8.jpg" />
								<img class="etalage_source_image" src="resources/images/8.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="resources/images/9.jpg" />
								<img class="etalage_source_image" src="resources/images/9.jpg" />
							</li>
						</ul>
					    </div>
				        <!-- end product_slider -->
				        <div class="single_right">
							...
							<ul class="add-to-links">
    			              <li><img src="resources/images/wish.png" alt=""><a href="#">Add to wishlist</a></li>
    			            </ul>
			...
			<div class="row">
				...
				<div class="col-md-4 product1">
					<img src="resources/images/s1.jpg" class="img-responsive" alt=""/> 
				...
				<div class="col-md-4 product1">
					<img src="resources/images/s2.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="single.html">
						</a><h3><a href="single.html"></a><a href="#">aliquam volutp</a></h3>
						<p>Lorem ipsum consectetuer adipiscing </p>
						<span class="reducedfrom">$66.00</span>
				...
				<div class="col-md-4">
					<img src="resources/images/s3.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="single.html">
						</a><h3><a href="single.html"></a><a href="#">aliquam volutp</a></h3>
						<p>Lorem ipsum consectetuer adipiscing </p>
						<span class="reducedfrom">$66.00</span>
